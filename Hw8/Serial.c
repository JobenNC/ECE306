...
int SMALL_RING_SIZE = 8;
int LARGE_RING_SIZE = 16;
int BEGINNING = 0;

extern volatile char USB_Char_Tx[8] = {0};
extern volatile char USB_Char_Rx[16] = {0};

extern volatile int usb_tx_ring_wr = 0;
extern volatile int usb_tx_ring_rd = 0;

extern volatile int usb_rx_ring_wr = 0;
extern volatile int usb_rx_ring_rd = 0;
